...
//   // Importar el archivo JavaScript correspondiente a la ruta actual
//   let module;
//   switch (path) {
//     case '/':
//       break;
//     case '/pacha8':
//       const ga = document.getElementById('pacha8')
//       ga.style.display = 'block';
//       const page = await import('./pacha8.js');
//       page.default()

//       break;
//     default:
//       // Enviar a una página de error si la ruta no se encuentra
//       console.error('404 Not Found');
//       return;
//   }
//   // Ejecutar la función de inicialización si está definida en el módulo importado
// }

// Llamar a la función navigate() al cargar la página y cuando cambie la ruta


// Llamar a la función navigate() cuando cambie la ruta
